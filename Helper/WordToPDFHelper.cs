...
namespace PDFwiz
{
    ...
    public static class WordToPDFHelper
    {
        ...
        public static bool WordToPDF(string inputPath, string outputPath, int startPage = 0, int endPage = 0,Application wordApplication = null, Document wordDocument = null)
        {
            bool oApplication = false;
            ...
            finally
            {
                ...
                //退出
                if (wordApplication != null && !oApplication)
                {
        ...
        public static void WordToPDFCreateLog(string inputPath, string outputPath, out string log, int startPage = 0, int endPage = 0)
        {
            ...
            {
                if (ex != null) { log = ex.ToString(); throw ex; }
            }
            finally
            {
                //关闭
